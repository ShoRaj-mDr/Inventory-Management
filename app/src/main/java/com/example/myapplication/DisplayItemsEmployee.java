    ...
    private final GraphQLCall.Callback<UpdateItemsMutation.Data> mutateCallback3 = new GraphQLCall.Callback<UpdateItemsMutation.Data>() {
        ...
        public void onResponse(@Nonnull final Response<UpdateItemsMutation.Data> response) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(DisplayItemsEmployee.this, "Updated Item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
        ...
        public void onFailure(@Nonnull final ApolloException e) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(DisplayItemsEmployee.this, "Failed to update item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
    ...
    private final GraphQLCall.Callback<DeleteItemsMutation.Data> mutateCallback2 = new GraphQLCall.Callback<DeleteItemsMutation.Data>() {
        ...
        public void onResponse(@Nonnull final Response<DeleteItemsMutation.Data> response) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(DisplayItemsEmployee.this, "Deleted Item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
        ...
        public void onFailure(@Nonnull final ApolloException e) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(DisplayItemsEmployee.this, "Failed to delete item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
    ...
    private final GraphQLCall.Callback<CreateItemsMutation.Data> mutateCallback = new GraphQLCall.Callback<CreateItemsMutation.Data>() {
        ...
        public void onResponse(@Nonnull final Response<CreateItemsMutation.Data> response) {
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(DisplayItemsEmployee.this, "Added Item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
        ...
        public void onFailure(@Nonnull final ApolloException e) {
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    Toast.makeText(DisplayItemsEmployee.this, "Failed to add item", Toast.LENGTH_SHORT).show();
                    DisplayItemsEmployee.this.finish();
                }
            });
        }
