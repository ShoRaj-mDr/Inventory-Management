...
public class CustomerMenuAdapter extends BaseAdapter {
    ...
    public CustomerMenuAdapter(Context applicationContext, String[] employeeMenu, int[] employeeMenuImage) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = layoutInflater.inflate(R.layout.activity_customer_menu_adapter, null);
